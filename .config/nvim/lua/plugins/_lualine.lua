      ...
      red      = '#ec5f67',
		...
		local config = {
			options = {
				...
				section_separators = "",
				-- theme = 'auto', -- or your preferred theme name
				...
				-- disabled_filetypes は削除、またはコメントアウトしてください
				-- disabled_filetypes = {
				--   statusline = { 'NvimTree' },
				--   winbar = {},
				-- },
			...
			sections = {
				...
				lualine_y = {},
				lualine_z = {},
				lualine_c = {}, -- これらはヘルパー関数によって埋められます
				lualine_x = {}, -- これらはヘルパー関数によって埋められます
			},
			inactive_sections = {
				lualine_a = {},
				lualine_b = {},
		...
		ins_right({
			require("plugins.lualine.cc-component"), -- この外部コンポーネントのcondも適切に処理されることを期待
			-- もしこのコンポーネントが関数を返す場合、その関数自体にcondを適用するか、
			-- このコンポーネントがテーブルを返すなら、そのテーブルにcondが追加されます。
			-- 詳細はcc-componentの実装によります。
		})
		ins_right({
			function()
				local icon = "🕒"
